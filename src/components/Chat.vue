<template>
  <div id="chat_wrap">
    <div class="chat_btn" :style="{'right': show?'12%':'0'}" @click="clickShow">
...
// }
// .tfw {
//   transition: width 0.25s ease-out, transform 0.25s ease-out, padding-top 0.5s,
