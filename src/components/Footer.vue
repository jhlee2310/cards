<template>
    <footer id="footer" style="position: relative;z-index: 2;">
        ...
        ">
            ...
            <div style="width:140px;height:30px;border-radius:15px;border: solid 1px #ffffff;color:#ffffff;font-family: Montserrat;
  font-size: 14px;
  font-weight: 500;
  font-style: normal;
  font-stretch: normal;
  ...
  text-align: left;
	...
	right: 0;
  ">
                <img style="margin-left:21px;margin-right:12px;vertical-align: middle;" src="@/assets/flag.png"/>
                <span>English</span>
            </div>
        </div>
    ...
    ">2019 Copyright. All rights reserved.
            ...
            <div style="margin-left: auto;">
                <img style="margin-right:10px;" src="@/assets/twitter.png"/>
                <img style="margin-right:10px;" src="@/assets/medium.png"/>
                <img src="@/assets/reddit.png"/>
            </div>
        </div>
        <div style="border-top: solid 1px rgba(142, 142, 142, 0.3);
        margin-top: 22px;
        padding-top:20px;
        margin-bottom: 33px;
        text-align: justify;
